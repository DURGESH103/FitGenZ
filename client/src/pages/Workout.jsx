...
import { ChevronDown, ChevronUp, Dumbbell, Clock, Zap, BarChart2 } from 'lucide-react'
          ...
          {workouts.map((w, wi) => {
            ...
            return (
              ...
              >
                {/* Card header */}
                <button
                  onClick={() => setExpanded(isOpen ? null : wi)}
                      ...
                      <div className="px-5 pb-5 pt-1 space-y-2 border-t border-white/6">
                        ...
                        {w.exercises?.map((ex, ei) => (
                          <motion.div
                            ...
                            className="flex items-center justify-between p-3.5 rounded-xl bg-white/5 hover:bg-white/8 transition-colors group"
                          >
                            ...
                            <div className="text-right shrink-0 ml-3">
                              {ex.sets && ex.reps && (
                                <p className="text-xs font-semibold text-purple-300 bg-purple-500/15 px-2 py-1 rounded-lg">
                                  {ex.sets} × {ex.reps}
                                </p>
                              )}
                              {ex.duration && (
                                <p className="text-xs font-semibold text-pink-300 bg-pink-500/15 px-2 py-1 rounded-lg">
                                  {ex.duration}
                                </p>
                              )}
                            </div>
